...
class ShoppingCardController extends GetxController {
  ...
  void addQuantityInProduct(ShoppingCardModel product) {
    _shoppingCardService.addAndRemoveProductInShoppingCard(product.product,
        quantity: product.quantity + 1);
  }

  void subtractQuantityInProduct(ShoppingCardModel product) {
    _shoppingCardService.addAndRemoveProductInShoppingCard(product.product,
        quantity: product.quantity - 1);
  }
